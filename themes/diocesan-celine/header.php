...
<body <?php body_class(); ?>>
    <div class="site" id="page">
        <a href="#content" class="skip-link screen-reader-text"><?php esc_html_e("Skip to content", "celine"); ?></a>

        <header class="site-header has-transparent-background-color"
            data-on-scroll-color="<?php echo TemplateController::getBackgroundColor("header_scroll"); ?>" id="masthead">
