 ...
 * Description: This is the base mu-plugins file for Codename Celine.
 * Version: 1.0.0
...
if (!function_exists('enqueue_mu_plugins')) {
    function enqueue_mu_plugins()
    {
        ...
        foreach ($folders as $folder) {
            require_once WPMU_PLUGIN_DIR . "/$folder/index.php";
        }
    }
    add_action('plugins_loaded', 'enqueue_mu_plugins'); // run on ACF initalization hook
}