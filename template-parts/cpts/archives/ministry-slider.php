    ...
    foreach ($groups as $group) :
        ...
        <div class="ministry-group same-height">
            ...
            <?php foreach ($ministries as $ministry) : ?>
                ...
                <div class="ministry-wrapper teaser-box" data-excerpt="<?php echo wp_trim_words($excerpt, 25); ?>" data-title="<?php echo $ministry->post_title; ?>" data-image="<?php echo get_the_post_thumbnail_url($ministry); ?>" data-link="<?php echo get_the_permalink($ministry); ?>" data-contact="<?php echo MinistriesController::getStaffMemberNamesByMinistry($ministry->ID); ?>" <?php echo TemplateController::animate("fade-left") ?>>
